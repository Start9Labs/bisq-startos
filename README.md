...
embassy-cli --host https://embassy-server-name.local package install bisq.s9pk
```
...
Go to your Embassy Services page, select **Bisq**, configure and start the service. Then, verify its interfaces are accessible.
